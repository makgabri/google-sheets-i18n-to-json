...
const NOTIFY = {
    ...
    token_auth_request: "Authorize google-sheets-i18n-to-json by visiting the following URL. Then copy and paste the code below:",
    ...
    success_clean: "Succesfully removed google-sheets-i18n-to-json files.",
